...
export const GradientModeProvider: React.FC<GradientModeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (savedMode && ['dark', 'neutral', 'light'].includes(savedMode)) {
      setMode(savedMode);
    }
  }, []);
  ...
  const getGradientClasses = (industry?: string): string => {
    const baseGradients = {
      dark: {
        default: 'from-[#0A2A4A] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]',
        marine: 'from-[#0D4A4A] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]',
        industrial: 'from-[#8B4513] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]',
        transportation: 'from-[#8B2A2A] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]',
        construction: 'from-[#8B6F47] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]',
        composites: 'from-[#6B6B6B] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]',
        insulation: 'from-[#8B2A5A] via-[#1b3764] via-[#1b3764] via-[#1b3764] to-[#1b3764]'
      },
      neutral: {
