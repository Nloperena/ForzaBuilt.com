        ...
        <div className="max-w-7xl mx-auto w-full">
              ...
              >
                {category.id === 'ruggedred' ? (
                  <a href="https://ruggedred.com" target="_blank" rel="noopener noreferrer">
                    <Card className="h-80 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 overflow-hidden bg-white/10 backdrop-blur-sm relative">
                      {/* Background Logo */}
                      ...
                      <CardContent className="relative z-10 h-full flex flex-col justify-between p-8 text-white">
                        {/* Header */}
                        <div>
                          <h3 className="text-3xl md:text-4xl font-kallisto font-bold mb-3" 
                              style={{ fontFamily: typography.products.fontFamily, fontWeight: typography.products.fontWeight }}>
                            {category.name}
                          </h3>
                          <p className="text-lg text-white/90 mb-2">{category.title}</p>
                        ...
                        <div className="flex items-center justify-between">
                          <Button className="bg-white/20 backdrop-blur-sm text-white border border-white/30 hover:bg-white/30 rounded-full px-6 py-3 text-lg font-semibold transition-all duration-300">
                            Visit RuggedRed.com
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-4xl mx-auto">
              <h3 className="text-2xl font-kallisto font-bold text-white mb-4" 
                  style={{ fontFamily: typography.headings.fontFamily, fontWeight: typography.headings.fontWeight }}>
                Browse by Industry
              </h3>
                ...
                {[
                  ...
                  >
                    <Link to={`/industries/${industry.id}`}>
                      <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer group-hover:scale-105">
                        <div className="flex flex-col items-center text-center">
                          <img 
                            src={industry.logo} 
                            alt={`${industry.name} icon`}
                            className="h-12 w-12 object-contain mb-3 group-hover:scale-110 transition-transform duration-300"
                          />
