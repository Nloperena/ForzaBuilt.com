...
interface StaticXRayExplorerV2Props {
  industry: IndustryData;
  xrayIndex?: number; // Which X-Ray component to display (0 or 1)
}

const StaticXRayExplorerV2: React.FC<StaticXRayExplorerV2Props> = ({ 
  industry, 
  xrayIndex = 0
}) => {
  ...
  const getIndustryLogo = (industry: string) => {
    switch (industry.toLowerCase()) {
      ...
      case 'transportation':
        return (
          <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            <path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5H6.5C5.84 5 5.28 5.42 5.08 6.01L3 12V20C3 20.55 3.45 21 4 21H5C5.55 21 6 20.55 6 20V19H18V20C18 20.55 18.45 21 19 21H20C20.55 21 21 20.55 21 20V20V12L18.92 6.01ZM6.5 16C5.67 16 5 15.33 5 14.5S5.67 13 6.5 13 8 13.67 8 14.5 7.33 16 6.5 16ZM17.5 16C16.67 16 16 15.33 16 14.5S16.67 13 17.5 13 19 13.67 19 14.5 18.33 16 17.5 16ZM5 11L6.5 6.5H17.5L19 11H5Z"/>
          </svg>
        );
      case 'composites':
        return (
  ...
  return (
    <section className="py-16 bg-white overflow-visible">
      <div className="w-full px-4">
        ...
        {/* Main Content - Single SVG with embedded image */}
        <div className="flex justify-center relative">
          ...
          >
            <div className="relative w-full aspect-square bg-transparent rounded-2xl overflow-visible">
              {/* Single SVG with embedded image and interactive hotspots */}
...
export default StaticXRayExplorerV2;
