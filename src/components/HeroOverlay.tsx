  ...
  return (
    <div className={`bg-gradient-to-b ${getGradientClasses()} pt-16 sm:pt-20 relative`}>
        ...
        <div className="text-center mx-auto">
          <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black ${getTextClasses()} mb-1 sm:mb-2 md:mb-4 leading-none font-kallisto`}>
            <SplitText
