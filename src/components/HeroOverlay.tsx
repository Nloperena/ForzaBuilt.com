    ...
    <div className="bg-[#1b3764] pt-16 sm:pt-20 shadow-2xl relative z-10">
        ...
        <div className="text-center w-full mx-auto">
          <SplitText
            ...
            className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-black text-white mb-1 sm:mb-2 md:mb-4 leading-none break-words w-full font-kallisto"
            splitType="words"
            delay={50}
            as="h1"
          />
