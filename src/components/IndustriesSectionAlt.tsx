        ...
        <div className="w-full flex flex-col items-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-14 gap-y-14 w-full max-w-[60rem] mb-14 mx-auto">
            {industriesArr.map((industry: Industry, index: number) => (
              ...
              >
                <Card
                  className="bg-white shadow-2xl rounded-[2rem] border border-gray-200 overflow-hidden aspect-square transition-all duration-300 hover:scale-105 min-h-[260px] md:min-h-[320px] lg:min-h-[360px] group cursor-pointer"
                  onMouseEnter={() => {
                ...
                >
                  <div className="relative w-full h-full overflow-hidden">
                    ...
                    <motion.img
                      ...
                      className="absolute right-0 z-20 transform transition-all duration-150"
                    ...
                    />
                    <motion.div
                      className="absolute bottom-0 left-0 right-0 bg-white rounded-b-[2rem] h-[72px] flex items-center px-8"
                      variants={childItemVariants}
                      initial="hidden"
                      animate="visible"
                    >
