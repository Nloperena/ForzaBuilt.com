    ...
    <>
      ...
      <div className="relative">
        <section className="sticky top-0 h-screen overflow-hidden bg-gradient-to-b from-[#115B87] to-[#1B3764] shadow-2xl">
          ...
          {/* Made In America Content - overlaid on the video */}
        ...
        <div className="relative" style={{ zIndex: 20 }}>
          {/* First: Fully Integrated U.S. Factory Section */}
          ...
          {/* Second: Newsletter Section - slides over after the factory content */}
          <div className="bg-white">
            <NewsletterSection />
          </div>
          
          {/* Any additional content that should slide over */}
          {children}
        </div>
      </div>
    </>
