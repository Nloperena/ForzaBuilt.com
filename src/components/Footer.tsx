...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0f1f39] text-white py-8 px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-[#F16022] hover:bg-[#F16022]/80 text-white rounded-full px-6 py-4 transition-all duration-200 text-lg font-bold shadow-lg hover:shadow-xl"
