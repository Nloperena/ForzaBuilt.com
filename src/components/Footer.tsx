        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-sm leading-relaxed" style={{ fontFamily: typography.body.fontFamily }}>
              ...
              <div className="flex items-center gap-10 mb-4">
                ...
                <div className="flex items-center gap-10">
                  <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors flex items-center">
                    <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                  </a>
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors flex items-center">
                    <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="text-white" style={{ fontFamily: typography.body.fontFamily, lineHeight: typography.body.lineHeight }}>Interested in working with us?</div>
              <div><a href="mailto:sales@forzabuilt.com" className="text-white font-semibold hover:underline" style={{ fontFamily: typography.body.fontFamily, lineHeight: typography.body.lineHeight }}>sales@forzabuilt.com</a></div>
            </div>
