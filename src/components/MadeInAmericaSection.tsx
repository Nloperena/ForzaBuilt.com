  ...
  return (
    <>
      <section className="bg-[rgb(243_245_247)]">
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] xl:grid-cols-[1.3fr_1fr] gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-8 items-start">
            ...
            <div className="flex justify-center lg:justify-start h-full">
              <div className="w-full h-full aspect-video lg:aspect-auto overflow-hidden rounded-2xl lg:rounded-3xl shadow-lg">
                <video
