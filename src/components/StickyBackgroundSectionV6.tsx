...
const StickyBackgroundSectionV6 = () => {
  return (
    <>
      ...
      <div className="relative">
        <section className="sticky top-0 h-[60vh] overflow-hidden bg-gradient-to-b from-[#115B87] to-[#1B3764] shadow-2xl">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 md:px-8" style={{ zIndex: 10 }}>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-black mb-4 md:mb-6 leading-none text-white font-kallisto drop-shadow-2xl">
        ...
        <div className="relative bg-white shadow-2xl" style={{ zIndex: 20, minHeight: '50vh' }}>
          {/* Content Section */}
          <section className="bg-gradient-to-b from-[#115B87] to-[#1B3764] pt-20 pb-20 shadow-inner">
            <div className="max-w-6xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black mb-6 sm:mb-8 font-kallisto leading-none text-white drop-shadow-lg">
                Fully Integrated U.S. Factory
              </h2>
              
              <p className="text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto mb-8 text-white/90 drop-shadow-sm">
...
export default StickyBackgroundSectionV6;
