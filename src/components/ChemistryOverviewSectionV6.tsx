  ...
  return (
    <>
      ...
      <div className="max-w-screen-2xl mx-auto relative z-10">
        <h2
          className="font-poppins font-normal text-white text-center leading-[1.12]
                     mt-[clamp(9px,1.75vw,20px)] mb-[clamp(18px,3.5vw,40px)]
        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div
            className="
              grid
              grid-cols-4 xs:grid-cols-4
              md:[grid-template-columns:repeat(6,minmax(9.5rem,1fr))]
              justify-items-center
              gap-x-2 gap-y-2 sm:gap-x-[clamp(14px,3vw,28px)] sm:gap-y-[clamp(18px,4vw,40px)]
              w-full
              mx-auto
