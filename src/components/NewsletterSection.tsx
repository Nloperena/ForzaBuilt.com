              ...
              <div className="bg-white/10 border border-white/20 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden h-full flex flex-col relative z-10">
                <div className="p-6 md:p-8 flex-1 flex flex-col">
                  ...
                  <div className="space-y-6 mt-auto">
                    ...
                    <p className="text-white/60 text-xs text-center">No spam, unsubscribe at any time</p>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    {recentPosts.map((post, index) => {
                      ...
                      return (
                        <a
                          key={post.id}
                          href={`/blog/${slug}`}
                          className="group block rounded-xl overflow-hidden bg-white/5 border border-white/10 hover:border-white/20 transition-all hover:bg-white/10"
                        >
                          <div className="flex gap-4">
                            <div className="w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 overflow-hidden bg-white/5 rounded-lg">
                              <img
                                src={post.image}
                                alt={post.title}
