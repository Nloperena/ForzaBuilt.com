...
const ProductChemistriesSection = () => {
  ...
  return (
    <section className="py-6 sm:py-8 md:py-10 lg:py-14 xl:py-16 bg-white/10 text-white relative">
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-8xl mx-auto z-10 relative">
        ...
        <div className="grid grid-cols-4 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-12">
                      {chemistryCategories.map((category, index) => (
              <div key={index} className="p-3 sm:p-4 md:p-6 lg:p-8 xl:p-12 min-h-[120px] sm:min-h-[150px] md:min-h-[200px] lg:min-h-[250px] xl:min-h-[300px]">
