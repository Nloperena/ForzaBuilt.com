...
const StickyBackgroundSectionV3 = () => {
  return (
    <>
      {/* Sticky Video Background Section */}
      <section className="relative h-[40vh] overflow-hidden">
        {/* Background Video - Always visible, no complex logic */}
        <video
          autoPlay
          muted
          loop
          ...
          style={{ zIndex: -10 }} // Far behind everything
        >
        ...
        {/* Content */}
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4 md:px-8 z-10">
      ...
      <div className="h-[20vh] bg-transparent relative">
        {/* This space allows scrolling while video stays fixed */}
      </div>
      
      {/* Content Section */}
      <section className="bg-gradient-to-b from-[#115B87] to-[#1B3764] pt-16 pb-16 relative z-20">
...
export default StickyBackgroundSectionV3;
