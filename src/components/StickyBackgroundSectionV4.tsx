...
const StickyBackgroundSectionV4 = () => {
  return (
    <>
      {/* Simple Video Background Section - No sticky, just working video */}
      <section className="relative h-[60vh] overflow-hidden bg-gradient-to-b from-[#115B87] to-[#1B3764]">
        {/* Background Video - Simple absolute positioning */}
        <video
          autoPlay
          muted
          loop
      ...
      {/* Content Section */}
      <section className="bg-gradient-to-b from-[#115B87] to-[#1B3764] pt-16 pb-16 relative">
...
export default StickyBackgroundSectionV4;
