export interface ProductDatasheet {
  ...
  industry: string[]; // Array of industries this product serves
  description: string;
  image: string;
  url: string;
  specifications: {
...
export const industrialDatasheet: ProductDatasheet[] = [
  // MARINE BOND PRODUCTS
  {
    id: 'tac-734g',
    name: 'TAC-734G – WEB SPRAY HIGH TACK INFUSION MOLDING ADHESIVE',
    category: 'BOND',
    industry: ['marine', 'composites', 'transportation'],
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Carbon Fiber', 'Marine Composites', 'Structural Foam'],
      applications: ['Boat Hulls', 'Deck Construction', 'Marine Equipment', 'Offshore Structures'],
      features: ['High Tack', 'Marine Grade', 'Salt Water Resistant', 'UV Stable'],
      certifications: ['Marine Approved', 'VOC Compliant'],
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Carbon Fiber', 'Marine Composites'],
      applications: ['Marine Construction', 'Automotive Parts', 'Aerospace Components'],
      features: ['No HAPS', 'Environmentally Friendly', 'Fast Drying', 'Resin Compatible'],
      certifications: ['HAPS Free', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.2 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Carbon Fiber', 'Marine Composites'],
      applications: ['Marine Construction', 'Automotive Parts', 'Aerospace Components'],
      features: ['Zero VOC', 'Clean Manufacturing', 'Marine Grade', 'High Performance'],
      certifications: ['Zero VOC', 'Marine Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.4 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Carbon Fiber', 'Marine Composites'],
      applications: ['Marine Construction', 'Automotive Parts', 'Aerospace Components'],
      features: ['Low Viscosity', 'Fast Drying', 'Resin Compatible', 'Marine Grade'],
      certifications: ['VOC Compliant', 'Marine Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.0 lbs/gal',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['marine', 'industrial', 'composites'],
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Marine Assembly', 'Industrial Bonding', 'Composite Construction'],
      features: ['Non-Flammable', 'Safe Handling', 'Marine Grade', 'Chemical Resistant'],
      certifications: ['Non-Flammable', 'Marine Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.0 lbs/gal',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['marine', 'industrial', 'automotive'],
    ...
    specifications: {
      ...
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Foam'],
      applications: ['Marine Assembly', 'Furniture Manufacturing', 'Automotive Interior'],
      features: ['CA Compliant', 'High Bond Strength', 'Fast Grab', 'Low VOC'],
      certifications: ['CARB Compliant', 'VOC Exempt'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.2 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Paper', 'Cardboard'],
      applications: ['Marine Assembly', 'Packaging', 'Labeling', 'Temporary Bonding'],
      features: ['Pressure Sensitive', 'Low Tack', 'Repositionable', 'Clean Release'],
      certifications: ['Food Safe', 'Low VOC'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.8 lbs/gal',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['marine', 'composites', 'industrial'],
    ...
    specifications: {
      ...
      cureTime: '12-24 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Marine Composites'],
      applications: ['Marine Assembly', 'Composite Construction', 'Packaging', 'Labeling'],
      features: ['Styrene Safe', 'Pressure Sensitive', 'Marine Grade', 'Chemical Resistant'],
      certifications: ['Styrene Safe', 'Marine Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.8 lbs/gal',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['marine', 'industrial', 'construction'],
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Marine Assembly', 'Automotive Assembly', 'Construction', 'Industrial Bonding'],
      features: ['Ultra High Strength', 'Moisture Cure', 'Marine Grade', 'Versatile'],
      certifications: ['VOC Compliant', 'Marine Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Marine Assembly', 'Automotive Assembly', 'Construction', 'Industrial Bonding'],
      features: ['High Strength', 'Single Part', 'Marine Grade', 'Versatile'],
      certifications: ['VOC Compliant', 'Marine Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '30 minutes',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Glass'],
      applications: ['Marine Assembly', 'Industrial Assembly', 'Equipment Repair', 'Automotive Repair'],
      features: ['Quick Setting', 'High Tack Strength', 'Structural Bond', 'Chemical Resistant'],
      certifications: ['Structural Bond', 'Marine Approved'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Composite'],
      applications: ['Marine Assembly', 'Structural Bonding', 'Industrial Assembly', 'Equipment Repair'],
      features: ['1:1 Mix Ratio', 'High Strength', 'Chemical Resistant', 'Temperature Resistant'],
      certifications: ['Structural Bond', 'Marine Approved'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Ceramic', 'Difficult Surfaces'],
      applications: ['Marine Assembly', 'Automotive Assembly', 'Electronics', 'Industrial Bonding'],
      features: ['Surface Preparation', 'Enhanced Adhesion', 'Fast Drying', 'Marine Grade'],
      certifications: ['Surface Preparation', 'Marine Approved'],
      packaging: ['8 oz Bottle', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '7.5 lbs/gal',
      pH: '6.0-7.0',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Ceramic', 'Difficult Surfaces'],
      applications: ['Marine Assembly', 'Surface Preparation', 'Electronics', 'Industrial Bonding'],
      features: ['Surface Preparation', 'Enhanced Adhesion', 'Fast Drying', 'Marine Grade'],
      certifications: ['Surface Preparation', 'Marine Approved'],
      packaging: ['8 oz Bottle', '1 Gallon', '5 Gallon']
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-40°F to +250°F',
      substrates: ['Metal', 'Rubber', 'Plastic', 'Fabric', 'Leather'],
      applications: ['Marine Assembly', 'Automotive Assembly', 'HVAC Systems', 'High-Temp Bonding'],
      features: ['High Heat Resistance', 'Chemical Resistant', 'Flexible Bond', 'Marine Grade'],
      certifications: ['Heat Resistant', 'Marine Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Rubber', 'Plastic', 'Fabric', 'Leather'],
      applications: ['Marine Assembly', 'Automotive Assembly', 'HVAC Systems', 'High-Temp Bonding'],
      features: ['Premium Grade', 'High Heat Resistance', 'Chemical Resistant', 'Marine Grade'],
      certifications: ['High Heat Resistant', 'Marine Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.2 lbs/gal',
  ...
  // INDUSTRIAL BOND PRODUCTS (existing ones with industry info)
  {
    id: 'ic933',
    name: 'IC933 – CA COMPLIANT MULTI-PURPOSE CONTACT ADHESIVE',
    category: 'BOND',
    industry: ['industrial', 'automotive', 'furniture'],
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +180°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Foam'],
      applications: ['Furniture Assembly', 'Automotive Interior', 'Textile Bonding', 'Industrial Lamination'],
      features: ['CA Compliant', 'High Bond Strength', 'Fast Grab', 'Low VOC'],
      certifications: ['CARB Compliant', 'VOC Exempt'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'packaging', 'labeling'],
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Paper', 'Cardboard'],
      applications: ['Packaging', 'Labeling', 'Temporary Bonding', 'Assembly'],
      features: ['Polystyrene Safe', 'Low Tack', 'Repositionable', 'Clean Release'],
      certifications: ['Food Safe', 'Low VOC'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'automotive', 'construction'],
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Glass', 'Ceramic'],
      applications: ['Automotive Assembly', 'Electronics', 'Construction', 'Industrial Bonding'],
      features: ['High Solids', 'CA Compliant', 'Excellent Adhesion', 'Chemical Resistance'],
      certifications: ['CARB Compliant', 'VOC Exempt'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'composites', 'automotive'],
    ...
    specifications: {
      ...
      cureTime: '6-12 hours',
      temperatureRange: '-20°F to +150°F',
      substrates: ['Fiberglass', 'Carbon Fiber', 'Kevlar', 'Composite Materials'],
      applications: ['Marine Construction', 'Automotive Parts', 'Aerospace Components', 'Wind Energy'],
      features: ['Low Viscosity', 'Fast Drying', 'Resin Compatible', 'No HAPS'],
      certifications: ['VOC Compliant', 'HAPS Free'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.2 lbs/gal',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'automotive', 'hvac'],
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +250°F',
      substrates: ['Metal', 'Rubber', 'Plastic', 'Fabric', 'Leather'],
      applications: ['Automotive Assembly', 'Industrial Equipment', 'HVAC Systems', 'High-Temp Bonding'],
      features: ['High Heat Resistance', 'Chemical Resistant', 'Flexible Bond', 'Durable'],
      certifications: ['Heat Resistant', 'Chemical Resistant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +180°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Foam'],
      applications: ['Furniture Manufacturing', 'Automotive Interior', 'Industrial Assembly', 'Construction'],
      features: ['High Solids Content', 'CA Compliant', 'Excellent Adhesion', 'Low VOC'],
      certifications: ['CARB Compliant', 'VOC Exempt'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'electronics', 'aerospace'],
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Paper'],
      applications: ['Electronics Assembly', 'Aerospace', 'Medical Equipment', 'Clean Room Applications'],
      features: ['Non-Flammable', 'Safe Handling', 'Low Toxicity', 'Clean Application'],
      certifications: ['Non-Flammable', 'Safety Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '12-24 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['FRP Panels', 'Fiberglass', 'Composite Materials', 'Metal', 'Wood'],
      applications: ['FRP Installation', 'Composite Bonding', 'Industrial Paneling', 'Structural Bonding'],
      features: ['Rollable Application', 'High Bond Strength', 'Chemical Resistant', 'Weather Resistant'],
      certifications: ['FRP Approved', 'Structural Bond'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '8-16 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Paper', 'Fabric', 'Film', 'Foil', 'Plastic'],
      applications: ['Flexible Packaging', 'Label Manufacturing', 'Textile Lamination', 'Industrial Coating'],
      features: ['Low Viscosity', 'Fast Drying', 'Good Penetration', 'Flexible Bond'],
      certifications: ['Food Safe', 'Low VOC'],
      packaging: ['5 Gallon', '55 Gallon', 'Totes']
    },
    technicalData: {
      density: '7.8 lbs/gal',
      pH: '6.5-7.0',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'construction', 'automotive'],
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Automotive Assembly', 'Construction', 'Industrial Bonding', 'Sealing'],
      features: ['Moisture Cure', 'Eco-Friendly', 'High Strength', 'Versatile'],
      certifications: ['VOC Compliant', 'Green Product'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.5 lbs/gal',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'flooring', 'carpet'],
    ...
    specifications: {
      ...
      substrates: ['Concrete', 'Wood Subfloor', 'Plywood', 'OSB'],
      applications: ['Flooring Installation', 'Carpet Bonding', 'Tile Adhesive', 'Industrial Flooring'],
      features: ['Trowellable', 'High Bond Strength', 'Moisture Resistant', 'Flexible'],
      certifications: ['Flooring Approved', 'Moisture Resistant'],
      packaging: ['5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +250°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Glass'],
      applications: ['Industrial Assembly', 'Equipment Repair', 'Automotive Repair', 'Construction'],
      features: ['Easy Application', 'Fast Curing', 'High Strength', 'Chemical Resistant'],
      certifications: ['Industrial Grade', 'Chemical Resistant'],
      packaging: ['1 lb Cartridge', '5 lb Cartridge', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'automotive', 'electronics'],
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Ceramic', 'Difficult Surfaces'],
      applications: ['Automotive Assembly', 'Electronics', 'Industrial Bonding', 'Surface Preparation'],
      features: ['Surface Preparation', 'Enhanced Adhesion', 'Fast Drying', 'Versatile'],
      certifications: ['Surface Preparation', 'Adhesion Promoter'],
      packaging: ['8 oz Bottle', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '7.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Structural Bonding', 'Automotive Assembly', 'Construction', 'Industrial Sealing'],
      features: ['Structural Strength', 'Moisture Cure', 'Thixotropic', 'Versatile'],
      certifications: ['Structural Bond', 'VOC Compliant'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      applications: ['Industrial Assembly', 'Equipment Repair', 'Automotive Repair', 'Construction'],
      features: ['Quick Setting', 'High Tack Strength', 'Structural Bond', 'Chemical Resistant'],
      certifications: ['Structural Bond', 'Quick Set'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
    technicalData: {
      density: '12.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +250°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Composite'],
      applications: ['Structural Bonding', 'Industrial Assembly', 'Equipment Repair', 'Construction'],
      features: ['1:1 Mix Ratio', 'High Strength', 'Chemical Resistant', 'Temperature Resistant'],
      certifications: ['Structural Bond', 'Chemical Resistant'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
    technicalData: {
      density: '11.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +180°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Glass'],
      applications: ['Rapid Assembly', 'Industrial Bonding', 'Equipment Repair', 'Automotive Assembly'],
      features: ['Fast Acting', 'High Strength', 'Rapid Cure', 'Versatile'],
      certifications: ['Fast Cure', 'High Strength'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
    technicalData: {
      density: '9.2 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '6-12 hours',
      temperatureRange: '-40°F to +250°F',
      substrates: ['Concrete', 'Steel', 'Masonry', 'Stone', 'Metal'],
      applications: ['Structural Anchoring', 'Concrete Repair', 'Heavy Equipment', 'Construction'],
      features: ['Structural Strength', 'High Load Capacity', 'Chemical Resistant', 'Weather Resistant'],
      certifications: ['Structural Anchor', 'High Load'],
      packaging: ['400 ml Dual Cartridge', '1 Gallon Kit', '5 Gallon Kit']
    },
    technicalData: {
      density: '13.5 lbs/gal',
      pH: 'Neutral',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Ceramic', 'Difficult Surfaces'],
      applications: ['Surface Preparation', 'Automotive Assembly', 'Electronics', 'Industrial Bonding'],
      features: ['Surface Preparation', 'Enhanced Adhesion', 'Fast Drying', 'Versatile'],
      certifications: ['Surface Preparation', 'Adhesion Promoter'],
      packaging: ['1 Quart', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '7.5 lbs/gal',
      pH: '6.0-7.0',
  ...
  },
  {
    ...
    category: 'BOND',
    industry: ['industrial', 'automotive', 'surface preparation'],
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fabric'],
      applications: ['Adhesive Removal', 'Surface Cleaning', 'Equipment Maintenance', 'Surface Preparation'],
      features: ['Citrus Based', 'Safe Handling', 'Effective Removal', 'Low Toxicity'],
      certifications: ['Safe Handling', 'Low Toxicity'],
      packaging: ['16 oz Spray', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '7.8 lbs/gal',
      pH: '6.5-7.5',
  ...
  // MARINE SEAL PRODUCTS
  {
    ...
    specifications: {
      ...
      cureTime: '24-72 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass'],
      applications: ['Marine Sealing', 'Boat Hulls', 'Deck Sealing', 'Marine Equipment', 'Offshore Structures'],
      features: ['Marine Grade', 'Salt Water Resistant', 'UV Stable', 'Flexible', 'Weather Resistant'],
      certifications: ['Marine Approved', 'VOC Compliant'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass'],
      applications: ['Marine Sealing', 'Boat Hulls', 'Deck Sealing', 'Marine Equipment', 'Offshore Structures'],
      features: ['Fast Skin', 'Marine Grade', 'Salt Water Resistant', 'UV Stable', 'Quick Cure'],
      certifications: ['Marine Approved', 'VOC Compliant'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
  ...
  // MARINE TAPE PRODUCTS
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Marine Assembly', 'Automotive Assembly', 'Industrial Bonding', 'Equipment Mounting'],
      features: ['Ultra High Bond', 'Marine Grade', 'Salt Water Resistant', 'UV Stable', 'Pressure Sensitive'],
      certifications: ['Marine Approved', 'Automotive Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  // CONSTRUCTION BOND PRODUCTS
  {
    ...
    specifications: {
      ...
      cureTime: '2-4 hours',
      temperatureRange: '-20°F to +180°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Paper'],
      applications: ['Construction Bonding', 'Industrial Assembly', 'Furniture Manufacturing', 'Packaging'],
      features: ['Low VOC', 'CA Compliant', 'Fast Drying', 'Aggressive Bond'],
      certifications: ['CA Compliant', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Styrene', 'Plastic', 'Metal', 'Wood', 'Fabric'],
      applications: ['High-Temp Bonding', 'Industrial Assembly', 'Automotive Parts', 'Construction'],
      features: ['High-Temp Resistant', 'Styrene Safe', 'Chemical Resistant', 'Durable'],
      certifications: ['High-Temp Rated', 'Styrene Safe'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.2 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Fiberglass'],
      applications: ['Construction Bonding', 'Industrial Assembly', 'Furniture Manufacturing', 'Automotive'],
      features: ['Non-Flammable', 'Safe Handling', 'Chemical Resistant', 'Durable'],
      certifications: ['Non-Flammable', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '2-6 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Paper', 'Fabric'],
      applications: ['General Bonding', 'Industrial Assembly', 'Packaging', 'Construction'],
      features: ['Versatile', 'Easy Application', 'Good Adhesion', 'Cost Effective'],
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Fiberglass'],
      applications: ['Construction Bonding', 'Industrial Assembly', 'Furniture Manufacturing', 'Automotive'],
      features: ['CA Compliant', 'Strong Bond', 'Chemical Resistant', 'Durable'],
      certifications: ['CA Compliant', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Paper'],
      applications: ['General Bonding', 'Industrial Assembly', 'Packaging', 'Construction'],
      features: ['Low VOC', 'CA Compliant', 'Easy Application', 'Versatile'],
      certifications: ['CA Compliant', 'VOC Compliant'],
      packaging: ['Aerosol Can', 'Bulk Containers']
    },
    technicalData: {
      density: '6.8 lbs/gal',
      pH: '6.5-7.0',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-30°F to +200°F',
      substrates: ['Neoprene', 'Rubber', 'Metal', 'Plastic', 'Fabric'],
      applications: ['High-Temp Bonding', 'Industrial Assembly', 'Automotive Parts', 'Construction'],
      features: ['High-Temp Resistant', 'Neoprene Compatible', 'Chemical Resistant', 'Durable'],
      certifications: ['High-Temp Rated', 'Neoprene Safe'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Fiberglass'],
      applications: ['Construction Bonding', 'Industrial Assembly', 'Furniture Manufacturing', 'Automotive'],
      features: ['Non-Flammable', 'Sprayable', 'Safe Handling', 'Chemical Resistant'],
      certifications: ['Non-Flammable', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Concrete', 'Fiberglass'],
      applications: ['Construction Bonding', 'Industrial Assembly', 'Automotive Parts', 'Marine'],
      features: ['Hybrid Polymer', 'Moisture Cure', 'High Performance', 'Chemical Resistant'],
      certifications: ['VOC Compliant', 'Moisture Cure'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.4 g/cm³',
      pH: 'Neutral',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Wood', 'Metal', 'Plastic', 'Concrete', 'Fiberglass'],
      applications: ['Construction Bonding', 'Industrial Assembly', 'Automotive Parts', 'Marine'],
      features: ['Hybrid Polymer', 'Single Component', 'Adhesive/Sealing', 'High Performance'],
      certifications: ['VOC Compliant', 'Single Component'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.5 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '2-4 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Fiberglass', 'Wood', 'Concrete'],
      applications: ['Structural Bonding', 'Industrial Assembly', 'Automotive Parts', 'Construction'],
      features: ['Two-Part', 'Methacrylate', 'High Strength', 'Fast Cure'],
      certifications: ['Structural Rated', 'Two-Part System'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
      density: '1.2 g/cm³',
      pH: 'Neutral',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Fiberglass', 'Wood', 'Concrete'],
      applications: ['Structural Bonding', 'Industrial Assembly', 'Automotive Parts', 'Construction'],
      features: ['Two-Part', 'Modified Epoxy', 'High Strength', 'Chemical Resistant'],
      certifications: ['Structural Rated', 'Two-Part System'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Fiberglass', 'Wood', 'Concrete'],
      applications: ['Quick Repairs', 'Industrial Assembly', 'Automotive Parts', 'Construction'],
      features: ['Fast Cure', 'Two-Part', 'High Strength', 'Quick Setting'],
      certifications: ['Fast Cure', 'Two-Part System'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Wood', 'Metal', 'Plastic', 'Concrete', 'Fiberglass'],
      applications: ['Quick Repairs', 'Industrial Assembly', 'Automotive Parts', 'Construction'],
      features: ['Quick Grab', 'Fast Setting', 'High Performance', 'Versatile'],
      certifications: ['VOC Compliant', 'Quick Setting'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.3 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: 'Immediate',
      temperatureRange: '-20°F to +140°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Fiberglass', 'Wood'],
      applications: ['Surface Preparation', 'Adhesion Promotion', 'Cleaning', 'Construction'],
      features: ['Isopropyl Alcohol', 'Cleaner', 'Adhesion Promoter', 'Fast Drying'],
      certifications: ['VOC Compliant', 'Cleaner Rated'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '6.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-72 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Concrete', 'Wood', 'Metal', 'Plastic', 'Fiberglass'],
      applications: ['Flooring Installation', 'Construction Bonding', 'Industrial Assembly', 'Automotive'],
      features: ['Trowel Grade', 'High Performance', 'Hybrid Polymer', 'Flooring Specific'],
      certifications: ['VOC Compliant', 'Flooring Rated'],
      packaging: ['3.5 Gallon Pail', '5 Gallon Pail', 'Bulk Containers']
    },
    technicalData: {
      density: '1.6 g/cm³',
      pH: 'Neutral',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +140°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Fiberglass', 'Wood'],
      applications: ['Tape Preparation', 'Adhesion Promotion', 'Surface Treatment', 'Construction'],
      features: ['Tape Primer', 'Adhesion Promoter', 'Fast Drying', 'Versatile'],
      certifications: ['VOC Compliant', 'Primer Rated'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['HPL', 'Wood', 'Metal', 'Plastic', 'Fiberglass'],
      applications: ['HPL Laminating', 'Construction Bonding', 'Industrial Assembly', 'Furniture'],
      features: ['HPL Specific', 'High Performance', 'Laminating Grade', 'Chemical Resistant'],
      certifications: ['VOC Compliant', 'HPL Rated'],
      packaging: ['5 Gallon Tote', '55 Gallon Drum', 'Bulk Containers']
    },
    technicalData: {
      density: '1.5 g/cm³',
      pH: 'Neutral',
  ...
  // TRANSPORTATION BOND PRODUCTS
  {
    id: 'tc452',
    name: 'TC452 – NON FLAM/NON-METHYLENE CHLORIDE CONTACT ADHESIVE',
    category: 'BOND',
    industry: ['transportation', 'industrial', 'automotive'],
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Paper'],
      applications: ['Transportation Assembly', 'Automotive Interior', 'Industrial Bonding', 'Equipment Assembly'],
      features: ['Non-Flammable', 'Safe Handling', 'Transportation Grade', 'Chemical Resistant'],
      certifications: ['Non-Flammable', 'Transportation Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +180°F',
      substrates: ['Wood', 'Metal', 'Plastic', 'Fabric', 'Foam'],
      applications: ['Transportation Assembly', 'Automotive Interior', 'Furniture Manufacturing', 'Industrial Bonding'],
      features: ['CA Compliant', 'High Bond Strength', 'Fast Grab', 'Low VOC'],
      certifications: ['CARB Compliant', 'VOC Exempt'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Paper', 'Cardboard'],
      applications: ['Transportation Assembly', 'Packaging', 'Labeling', 'Temporary Bonding'],
      features: ['Pressure Sensitive', 'Low Tack', 'Repositionable', 'Clean Release'],
      certifications: ['Food Safe', 'Low VOC'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Paper', 'Cardboard'],
      applications: ['Transportation Assembly', 'Packaging', 'Labeling', 'Temporary Bonding'],
      features: ['Semi-Pressure Sensitive', 'CA Compliant', 'Low Tack', 'Repositionable'],
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Paper', 'Cardboard'],
      applications: ['Transportation Assembly', 'Packaging', 'Labeling', 'Temporary Bonding'],
      features: ['Low VOC', 'CA Compliant', 'Aggressive', 'Fast Drying'],
      certifications: ['CARB Compliant', 'Low VOC'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '12-24 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Polystyrene', 'Polyethylene', 'Polypropylene', 'Transportation Composites'],
      applications: ['Transportation Assembly', 'Composite Construction', 'Packaging', 'Labeling'],
      features: ['High-Temp', 'Styrene Safe', 'Pressure Sensitive', 'Transportation Grade'],
      certifications: ['Styrene Safe', 'Transportation Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Ceramic', 'Difficult Surfaces'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Electronics', 'Industrial Bonding'],
      features: ['Surface Preparation', 'Enhanced Adhesion', 'Fast Drying', 'Transportation Grade'],
      certifications: ['Surface Preparation', 'Transportation Approved'],
      packaging: ['8 oz Bottle', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '7.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Construction', 'Industrial Bonding'],
      features: ['Structural Strength', 'Transportation Grade', 'Versatile', 'High Performance'],
      certifications: ['Structural Bond', 'Transportation Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Ceramic', 'Difficult Surfaces'],
      applications: ['Transportation Assembly', 'Surface Preparation', 'Electronics', 'Industrial Bonding'],
      features: ['Surface Preparation', 'Enhanced Adhesion', 'Fast Drying', 'Transportation Grade'],
      certifications: ['Surface Preparation', 'Transportation Approved'],
      packaging: ['8 oz Bottle', '1 Gallon', '5 Gallon']
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +250°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Composite'],
      applications: ['Transportation Assembly', 'Structural Bonding', 'Industrial Assembly', 'Equipment Repair'],
      features: ['1:1 Mix Ratio', 'High Strength', 'Chemical Resistant', 'Temperature Resistant'],
      certifications: ['Structural Bond', 'Transportation Approved'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +180°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Ceramic', 'Glass'],
      applications: ['Rapid Transportation Assembly', 'Industrial Bonding', 'Equipment Repair', 'Automotive Assembly'],
      features: ['Fast Acting', 'High Strength', 'Rapid Cure', 'Transportation Grade'],
      certifications: ['Fast Cure', 'Transportation Approved'],
      packaging: ['50 ml Dual Cartridge', '200 ml Dual Cartridge', '400 ml Dual Cartridge']
    },
    technicalData: {
      density: '9.2 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Construction', 'Industrial Bonding'],
      features: ['Structural Strength', 'Moisture Cure', 'Single Part', 'Transportation Grade'],
      certifications: ['Structural Bond', 'Transportation Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Construction', 'Industrial Bonding'],
      features: ['High Green Strength', 'Quick Grab', 'Transportation Grade', 'Versatile'],
      certifications: ['Quick Grab', 'Transportation Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +250°F',
      substrates: ['Metal', 'Rubber', 'Plastic', 'Fabric', 'Leather'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'HVAC Systems', 'High-Temp Bonding'],
      features: ['High Heat Resistance', 'Chemical Resistant', 'Flexible Bond', 'Transportation Grade'],
      certifications: ['Heat Resistant', 'Transportation Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Paper'],
      applications: ['Transportation Assembly', 'Automotive Interior', 'Industrial Bonding', 'Equipment Assembly'],
      features: ['Non-Flammable', 'Safe Handling', 'Sprayable', 'Transportation Grade'],
      certifications: ['Non-Flammable', 'Transportation Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Rubber', 'Plastic', 'Fabric', 'Leather'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'HVAC Systems', 'High-Temp Bonding'],
      features: ['Premium Grade', 'High Heat Resistance', 'Chemical Resistant', 'Transportation Grade'],
      certifications: ['High Heat Resistant', 'Transportation Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.2 lbs/gal',
  ...
  // CONSTRUCTION SEAL PRODUCTS
  {
    id: 'c-os9',
    name: 'C-OS9 – HYBRID POLYMER, STRUCTURAL, SINGLE-PART, MOISTURE CURE ADHESIVE',
    category: 'SEAL',
    industry: ['construction', 'industrial'],
    description: 'Hybrid polymer structural single-part moisture cure adhesive for construction applications requiring superior sealing performance.',
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass'],
      applications: ['Construction Sealing', 'Structural Bonding', 'Industrial Assembly', 'Automotive Parts'],
      features: ['Hybrid Polymer', 'Structural', 'Single-Part', 'Moisture Cure', 'High Performance'],
      certifications: ['VOC Compliant', 'Structural Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.5 g/cm³',
  ...
  // TRANSPORTATION SEAL PRODUCTS
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass'],
      applications: ['Transportation Sealing', 'Automotive Assembly', 'Equipment Sealing', 'Industrial Sealing'],
      features: ['Semi-Self Leveling', 'High Performance', 'Transportation Grade', 'Weather Resistant'],
      certifications: ['Transportation Approved', 'VOC Compliant'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass'],
      applications: ['Transportation Sealing', 'Automotive Assembly', 'Equipment Sealing', 'Industrial Sealing'],
      features: ['Non-Hazardous', 'High Strength', 'Single Part', 'Transportation Grade'],
      certifications: ['Non-Hazardous', 'Transportation Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass'],
      applications: ['Transportation Sealing', 'Automotive Assembly', 'Equipment Sealing', 'Industrial Sealing'],
      features: ['Silicone Based', 'High Flexibility', 'Weather Resistant', 'Transportation Grade'],
      certifications: ['Silicone Approved', 'Transportation Approved'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon']
    },
    technicalData: {
      density: '12.5 lbs/gal',
  ...
  // COMPOSITES BOND PRODUCTS
  {
    id: 'tac-734g',
    name: 'TAC-734G – WEB SPRAY HIGH TACK INFUSION MOLDING ADHESIVE',
    category: 'BOND',
    industry: ['composites', 'industrial'],
    ...
    specifications: {
      ...
      cureTime: '8-16 hours',
      temperatureRange: '-30°F to +160°F',
      substrates: ['Fiberglass', 'Carbon Fiber', 'Composite Materials', 'Structural Foam'],
      applications: ['Composite Manufacturing', 'Infusion Molding', 'Structural Bonding', 'Industrial Assembly'],
      features: ['High Tack', 'Infusion Molding', 'Composite Grade', 'Structural Bonding'],
      certifications: ['Composite Approved', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.6 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '6-12 hours',
      temperatureRange: '-20°F to +150°F',
      substrates: ['Fiberglass', 'Carbon Fiber', 'Composite Materials'],
      applications: ['Composite Manufacturing', 'Infusion Molding', 'Structural Bonding', 'Industrial Assembly'],
      features: ['No HAPS', 'Environmentally Friendly', 'Infusion Molding', 'Composite Grade'],
      certifications: ['HAPS Free', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Carbon Fiber', 'Composite Materials'],
      applications: ['Composite Manufacturing', 'Infusion Molding', 'Structural Bonding', 'Industrial Assembly'],
      features: ['Zero VOC', 'Clean Manufacturing', 'Infusion Molding', 'Composite Grade'],
      certifications: ['Zero VOC', 'Composite Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.4 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '6-12 hours',
      temperatureRange: '-20°F to +140°F',
      substrates: ['Polymer Concrete', 'Composite Materials', 'Fiberglass', 'Carbon Fiber'],
      applications: ['Polymer Concrete Molding', 'Composite Manufacturing', 'Process Tackifier', 'Industrial Assembly'],
      features: ['Mist Spray', 'Polymer Concrete', 'Process Tackifier', 'Composite Grade'],
      certifications: ['VOC Compliant', 'Composite Approved'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '2-4 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Fiberglass', 'Carbon Fiber', 'Composite Materials'],
      applications: ['Composite Assembly', 'Structural Bonding', 'Industrial Assembly', 'Automotive Parts'],
      features: ['Two-Part', 'Methacrylate', 'High Strength', 'Fast Cure'],
      certifications: ['Structural Rated', 'Two-Part System'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-72 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass', 'Carbon Fiber'],
      applications: ['Composite Assembly', 'Structural Bonding', 'Industrial Assembly', 'Automotive Parts'],
      features: ['Ultra High Strength', 'Hybrid Polymer', 'Structural', 'High Performance'],
      certifications: ['VOC Compliant', 'Structural Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
  ...
  // COMPOSITES SEAL PRODUCTS
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass', 'Carbon Fiber'],
      applications: ['Composite Sealing', 'Structural Sealing', 'Industrial Sealing', 'Automotive Sealing'],
      features: ['Neutral Cure', 'Oxime Silicone', 'High Performance', 'Weather Resistant'],
      certifications: ['VOC Compliant', 'Sealant Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  // INSULATION BOND PRODUCTS
  {
    id: 'rc826',
    name: 'RC826 – LOW VOC, CA COMPLIANT, MULTI-PURPOSE ADHESIVE',
    category: 'BOND',
    industry: ['insulation', 'industrial'],
    ...
    specifications: {
      ...
      cureTime: '6-12 hours',
      temperatureRange: '-20°F to +150°F',
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Low VOC', 'CA Compliant', 'Multi-Purpose', 'Environmentally Friendly'],
      certifications: ['Low VOC', 'CA Compliant'],
      packaging: ['Aerosol Can', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '7.0 lbs/gal',
      pH: '6.5-7.0',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Non-Flammable', 'Safe Handling', 'Contact Adhesive', 'Chemical Resistant'],
      certifications: ['Non-Flammable', 'Safe for Insulation'],
      packaging: ['Canister', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '8.0 lbs/gal',
      pH: '6.5-7.0',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Low VOC', 'CA Compliant', 'Contact Adhesive', 'Environmentally Friendly'],
      certifications: ['Low VOC', 'CA Compliant'],
      packaging: ['Canister', '1 Gallon', '5 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Aggressive', 'Fast Drying', 'Pressure Sensitive', 'High Performance'],
      certifications: ['Industrial Grade', 'Pressure Sensitive'],
      packaging: ['Canister', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '8.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Low VOC', 'CA Compliant', 'Aggressive', 'Fast Drying', 'Pressure Sensitive'],
      certifications: ['Low VOC', 'CA Compliant', 'Pressure Sensitive'],
      packaging: ['Canister', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '8.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['High Temperature Insulation', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['High Temperature', 'Pressure Sensitive', 'Thermal Resistant', 'High Performance'],
      certifications: ['High Temperature Rated', 'Pressure Sensitive'],
      packaging: ['Canister', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '9.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Fiberglass', 'Foam', 'Metal', 'Plastic', 'Wood', 'Fabric'],
      applications: ['Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Non-Flammable', 'Spray Application', 'High Performance', 'Safe Handling'],
      certifications: ['Non-Flammable', 'Spray Grade'],
      packaging: ['Spray Can', '1 Gallon', '5 Gallon Pail']
    },
    technicalData: {
      density: '7.5 lbs/gal',
      pH: '6.5-7.0',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '4-8 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Fiberglass', 'Foam', 'Wood', 'Concrete'],
      applications: ['Structural Insulation Bonding', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Two-Part', 'Epoxy', 'High Strength', 'Structural Bonding'],
      certifications: ['Structural Rated', 'Two-Part System'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '8-16 hours',
      temperatureRange: '-20°F to +150°F',
      substrates: ['Fiberglass', 'Foam', 'Fabric', 'Paper', 'Foil', 'Plastic'],
      applications: ['Insulation Laminating', 'Industrial Assembly', 'Construction Bonding', 'Equipment Mounting'],
      features: ['Low/Medium Viscosity', 'Laminating', 'Precise Control', 'High Performance'],
      certifications: ['Laminating Grade', 'VOC Compliant'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.8 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Fiberglass', 'Foam', 'Wood', 'Glass'],
      applications: ['Surface Preparation', 'Adhesion Promotion', 'Cleaning', 'Pre-Bonding Treatment'],
      features: ['Isopropyl Alcohol', 'Cleaner', 'Adhesion Promoter', 'Surface Preparation'],
      certifications: ['Cleaning Grade', 'Adhesion Promoter'],
      packaging: ['Spray Bottle', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '6.6 lbs/gal',
      pH: 'Neutral',
  ...
  // INSULATION SEAL PRODUCTS
  {
    ...
    specifications: {
      ...
      cureTime: '24-72 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass', 'Foam'],
      applications: ['Insulation Sealing', 'Structural Sealing', 'Industrial Sealing', 'Construction Sealing'],
      features: ['Non-Hazardous', 'High Strength', 'Moisture Cure', 'Hybrid Polymer'],
      certifications: ['Non-Hazardous', 'Sealant Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.4 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Fiberglass', 'Foam'],
      applications: ['Insulation Sealing', 'Structural Sealing', 'Industrial Sealing', 'Construction Sealing'],
      features: ['Single-Component', 'Silicone', 'High Performance', 'Weather Resistant'],
      certifications: ['Silicone Rated', 'Sealant Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  // INSULATION TAPE PRODUCTS
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Foam'],
      applications: ['Thermal Break', 'Insulation Bonding', 'Industrial Assembly', 'Construction Bonding'],
      features: ['Thermal Break', 'Foam Cushioning', 'Insulation Grade', 'Pressure Sensitive'],
      certifications: ['Thermal Break Rated', 'Insulation Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Foam'],
      applications: ['Thermal Management', 'Insulation Bonding', 'Industrial Assembly', 'Construction Bonding'],
      features: ['Low Density', 'Reverse Wound', 'PVS', 'Thermal Management'],
      certifications: ['Thermal Rated', 'Insulation Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Foam'],
      applications: ['Cold Temperature Bonding', 'Insulation Bonding', 'Industrial Assembly', 'Construction Bonding'],
      features: ['Cold Temperature', 'Double Coated', 'High Performance', 'Pressure Sensitive'],
      certifications: ['Cold Temperature Rated', 'Insulation Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  // INDUSTRIAL BOND PRODUCTS
  {
    ...
    specifications: {
      ...
      cureTime: '24-48 hours',
      temperatureRange: '-20°F to +160°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['Non-Flammable', 'Safe Handling', 'Contact Adhesive', 'Chemical Resistant'],
      certifications: ['Non-Flammable', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['CA Compliant', 'High Strength', 'Contact Adhesive', 'Environmentally Friendly'],
      certifications: ['CA Compliant', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '8.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['Styrene Safe', 'Pressure Sensitive', 'Safe Handling', 'High Performance'],
      certifications: ['Styrene Safe', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['CA Compliant', 'Pressure Sensitive', 'Environmentally Friendly', 'High Performance'],
      certifications: ['CA Compliant', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['High-Temperature Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['High-Temperature', 'Styrene Safe', 'Pressure Sensitive', 'High Performance'],
      certifications: ['High-Temperature Rated', 'Styrene Safe', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['High Performance', 'Neoprene', 'Contact Adhesive', 'Chemical Resistant'],
      certifications: ['High Performance', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.0 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['High-Temperature Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['High Heat', 'Neoprene', 'Thermal Resistant', 'Chemical Resistant'],
      certifications: ['High Heat Rated', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '9.5 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['CA Compliant', 'Contact Adhesive', 'Environmentally Friendly', 'High Performance'],
      certifications: ['CA Compliant', 'Industrial Grade'],
      packaging: ['1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Wood', 'Fabric', 'Glass', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'General Bonding'],
      features: ['Non-Flammable', 'Sprayable', 'Contact Adhesive', 'Safe Handling'],
      certifications: ['Non-Flammable', 'Spray Grade', 'Industrial Grade'],
      packaging: ['Spray Can', '1 Gallon', '5 Gallon', '55 Gallon']
    },
    technicalData: {
      density: '7.5 lbs/gal',
      pH: '6.5-7.0',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '4-8 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['FRP', 'Metal', 'Plastic', 'Wood', 'Concrete'],
      applications: ['FRP Installation', 'Industrial Assembly', 'Equipment Bonding', 'Manufacturing'],
      features: ['Hybrid Polymer', 'Rollable', 'FRP Grade', 'High Performance'],
      certifications: ['FRP Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.3 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '24-72 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'Sealing Applications'],
      features: ['Hybrid Polymer', 'Adhesive/Sealant', 'High Performance', 'Versatile'],
      certifications: ['Industrial Grade', 'Sealant Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.4 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Industrial Mounting', 'Equipment Assembly', 'Manufacturing', 'General Bonding'],
      features: ['High Green Strength', 'Mounting Adhesive', 'Fast Cure', 'High Performance'],
      certifications: ['Mounting Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.5 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'Fast Bonding'],
      features: ['Fast Grab', 'Hybrid Polymer', 'Immediate Bonding', 'High Performance'],
      certifications: ['Fast Grab Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.6 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Structural Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'High-Strength Bonding'],
      features: ['Ultra High Strength', 'Hybrid Polymer', 'Structural', 'High Performance'],
      certifications: ['Structural Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.7 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: 'Immediate',
      temperatureRange: '-20°F to +100°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Ceramic'],
      applications: ['Surface Preparation', 'Adhesion Promotion', 'Pre-Bonding Treatment', 'Industrial Assembly'],
      features: ['Primer', 'Adhesion Promoter', 'Surface Preparation', 'Industrial Grade'],
      certifications: ['Primer Rated', 'Industrial Grade'],
      packaging: ['Spray Bottle', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '6.6 lbs/gal',
  ...
  },
  {
    ...
    specifications: {
      ...
      cureTime: '2-4 hours',
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Fast Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'Quick Repairs'],
      features: ['Two-Part', '5-Minute Cure', 'Epoxy', 'Fast Bonding'],
      certifications: ['Two-Part System', 'Industrial Grade'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Structural Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'High-Strength Bonding'],
      features: ['Two-Part', 'Modified Epoxy', 'High Strength', 'Structural Bonding'],
      certifications: ['Structural Rated', 'Two-Part System', 'Industrial Grade'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
      density: '1.3 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['High-Performance Industrial Assembly', 'Equipment Bonding', 'Manufacturing', 'Structural Bonding'],
      features: ['Two-Part', 'Methacrylate', 'High Performance', 'Fast Cure'],
      certifications: ['High Performance Rated', 'Two-Part System', 'Industrial Grade'],
      packaging: ['Dual Cartridge', 'Bulk Containers']
    },
    technicalData: {
      density: '1.4 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-20°F to +100°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Ceramic'],
      applications: ['Surface Preparation', 'Tape Adhesion Promotion', 'Pre-Tape Treatment', 'Industrial Assembly'],
      features: ['Tape Primer', 'Adhesion Promoter', 'Surface Preparation', 'Industrial Grade'],
      certifications: ['Tape Primer Rated', 'Industrial Grade'],
      packaging: ['Paint Can', '1 Gallon', '5 Gallon']
    },
    technicalData: {
      density: '6.6 lbs/gal',
      pH: 'Neutral',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Ceramic'],
      applications: ['Instant Industrial Assembly', 'Quick Repairs', 'Manufacturing', 'Fast Bonding'],
      features: ['Instant', 'Fast Cure', 'High Performance', 'Quick Bonding'],
      certifications: ['Instant Rated', 'Industrial Grade'],
      packaging: ['Bottle', 'Bulk Containers']
    },
    technicalData: {
      density: '1.1 g/cm³',
      pH: 'Neutral',
  ...
  // INDUSTRIAL SEAL PRODUCTS
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'General Sealing'],
      features: ['Multi-Purpose', 'Hybrid Polymer', 'High Performance', 'Versatile'],
      certifications: ['Industrial Grade', 'Sealant Rated'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['High-Performance Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'General Sealing'],
      features: ['Performance Polymer', 'High Performance', 'Versatile', 'Industrial Grade'],
      certifications: ['Performance Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.4 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['High-Strength Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'Adhesive/Sealant Applications'],
      features: ['High Strength', 'Hybrid Polymer', 'Adhesive/Sealant', 'High Performance'],
      certifications: ['High Strength Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.5 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Flexible Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'General Sealing'],
      features: ['Low Modulus', 'Performance Polymer', 'Flexible', 'High Performance'],
      certifications: ['Low Modulus Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.3 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Self-Leveling Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'Smooth Surface Sealing'],
      features: ['Self-Leveling', 'Hybrid Polymer', 'Smooth Surface', 'High Performance'],
      certifications: ['Self-Leveling Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Industrial Silicone Sealing', 'Equipment Sealing', 'Manufacturing', 'General Sealing'],
      features: ['Single Component', 'Silicone', 'High Performance', 'Weather Resistant'],
      certifications: ['Silicone Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Industrial Acetoxy Silicone Sealing', 'Equipment Sealing', 'Manufacturing', 'General Sealing'],
      features: ['Acetoxy Silicone', 'High Performance', 'Weather Resistant', 'Industrial Grade'],
      certifications: ['Acetoxy Silicone Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['Self-Leveling Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'Smooth Surface Sealing'],
      features: ['Self-Leveling', 'Performance Polymer', 'Smooth Surface', 'High Performance'],
      certifications: ['Self-Leveling Rated', 'Performance Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.2 g/cm³',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Glass', 'Plastic', 'Wood', 'Concrete', 'Ceramic'],
      applications: ['High Performance Industrial Sealing', 'Equipment Sealing', 'Manufacturing', 'Adhesive/Sealant Applications'],
      features: ['High Performance', 'Semi Self-Leveling', 'Adhesive/Sealant', 'Versatile'],
      certifications: ['High Performance Rated', 'Industrial Grade'],
      packaging: ['10.3 oz Cartridge', '29 oz Sausage', '5 Gallon Pail']
    },
    technicalData: {
      density: '1.3 g/cm³',
  ...
  // CONSTRUCTION TAPE PRODUCTS
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Construction Assembly', 'Industrial Bonding', 'Equipment Mounting', 'Cushioning'],
      features: ['Foam Cushioning', 'Construction Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Construction Approved', 'Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Construction Assembly', 'Industrial Bonding', 'Equipment Mounting', 'Structural Bonding'],
      features: ['Ultra High Bond', 'Construction Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Construction Approved', 'Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Construction Assembly', 'Industrial Bonding', 'Equipment Mounting', 'General Bonding'],
      features: ['High Bond', 'Construction Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Construction Approved', 'Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Construction Assembly', 'Industrial Bonding', 'Equipment Mounting', 'Cushioning'],
      features: ['PE Foam', 'Construction Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Construction Approved', 'Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Construction Assembly', 'Industrial Bonding', 'Equipment Mounting', 'General Bonding'],
      features: ['Double-Sided', 'Construction Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Construction Approved', 'Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Construction Assembly', 'Industrial Bonding', 'Equipment Mounting', 'General Bonding'],
      features: ['PET Backing', 'Construction Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Construction Approved', 'Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  // TRANSPORTATION TAPE PRODUCTS
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Industrial Bonding', 'Equipment Mounting'],
      features: ['Ultra High Bond', 'Transportation Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Transportation Approved', 'Automotive Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Gasketing', 'Equipment Mounting'],
      features: ['Foam Gasketing', 'Transportation Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Transportation Approved', 'Automotive Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'Extreme Sealing', 'Equipment Mounting'],
      features: ['Extreme Sealing', 'Transportation Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Transportation Approved', 'Automotive Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      temperatureRange: '-40°F to +200°F',
      substrates: ['Metal', 'Plastic', 'Glass', 'Wood', 'Fiberglass', 'Composite'],
      applications: ['Transportation Assembly', 'Automotive Assembly', 'PE Sealing', 'Equipment Mounting'],
      features: ['PE Sealing', 'Transportation Grade', 'Weather Resistant', 'Pressure Sensitive'],
      certifications: ['Transportation Approved', 'Automotive Grade'],
      packaging: ['36 yard rolls', 'Various widths', 'Bulk packaging']
    },
    technicalData: {
  ...
  // INDUSTRIAL TAPE PRODUCTS
  {
    ...
    category: 'TAPE',
    industry: ['industrial', 'transportation', 'construction'],
    ...
    specifications: {
      ...
      applications: ['Industrial Assembly', 'Automotive Manufacturing', 'Construction', 'Signage'],
      features: ['Ultra High Bond', 'Acrylic Adhesive', 'Foam Core', 'Weather Resistant'],
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Heavy Industrial Assembly', 'Automotive Manufacturing', 'Construction', 'Signage'],
      features: ['Ultra High Bond', 'Acrylic Adhesive', 'Foam Core', 'Weather Resistant'],
      certifications: ['Industrial Grade', 'VHB Technology'],
      packaging: ['36 yard rolls', 'Various widths']
    },
  ...
  },
  {
    ...
    name: 'T305 – FOAM TAPE',
    category: 'TAPE',
    industry: ['industrial', 'construction', 'transportation'],
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Industrial Mounting', 'Construction', 'Automotive', 'Signage'],
      features: ['High Performance', 'Foam Core', 'Weather Resistant', 'Easy Application'],
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Thermal Insulation', 'Construction', 'Automotive', 'Industrial Equipment'],
      features: ['Thermal Break', 'Insulating', 'Weather Resistant', 'High Performance'],
      certifications: ['Thermal Insulation Grade'],
      packaging: ['36 yard rolls', 'Various widths']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Industrial Bonding', 'Construction', 'Automotive', 'Signage'],
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Gasketing', 'Sealing', 'Industrial Equipment', 'Automotive'],
      features: ['Gasketing', 'Sealing', 'Weather Resistant', 'High Performance'],
      certifications: ['Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Cold Temperature Applications', 'Industrial Equipment', 'Automotive', 'Construction'],
      features: ['Cold Temperature', 'Double-Coated', 'Weather Resistant', 'High Performance'],
      certifications: ['Cold Temperature Grade'],
      packaging: ['36 yard rolls', 'Various widths']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Sealing', 'Bonding', 'Industrial Equipment', 'Construction'],
      features: ['Butyl Adhesive', 'Sealing', 'Weather Resistant', 'High Performance'],
      certifications: ['Industrial Grade'],
      packaging: ['36 yard rolls', 'Various widths']
    },
    technicalData: {
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['FSK Applications', 'Industrial Equipment', 'Construction', 'Automotive'],
      features: ['FSK Technology', 'High Performance', 'Weather Resistant', 'Specialized Application'],
      certifications: ['FSK Grade'],
      packaging: ['36 yard rolls', 'Various widths']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
  ...
  },
  {
    ...
    specifications: {
      ...
      length: '36 yards per roll',
      substrates: ['Metal', 'Plastic', 'Glass', 'Painted Surfaces'],
      applications: ['Foil Applications', 'Industrial Equipment', 'Construction', 'Automotive'],
      features: ['Foil Backing', 'High Performance', 'Weather Resistant', 'Specialized Application'],
      certifications: ['Foil Grade'],
      packaging: ['36 yard rolls', 'Various widths']
    },
    technicalData: {
      adhesiveType: 'Acrylic',
...
export const getProductsByIndustry = (industry: string) => {
  ...
  // For industrial, only return products that are exclusively industrial
  if (industry === 'industrial') {
    return industrialDatasheet.filter(product => 
      product.industry.length === 1 && product.industry[0] === 'industrial'
    );
  }
  
  // For other industries, return products that include the industry
  return industrialDatasheet.filter(product => product.industry.includes(industry));
};
